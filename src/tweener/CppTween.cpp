...
namespace tween {
        ...
        float Elastic::easeIn (float t,float b , float c, float d) {
                ...
                return -(postFix * sin((t*d-s)*(2*_PI)/p )) + b;
        }
        ...
        float Elastic::easeOut(float t,float b , float c, float d) {
                ...
                float a=c;
                float s=p/4;
                return (a*pow(2,-10*t) * sin( (t*d-s)*(2*_PI)/p ) + c + b);
        }
        ...
        float Elastic::easeInOut(float t,float b , float c, float d) {
                ...
                if (t < 1) {
                        ...
                        return -.5f*(postFix* sin( (t*d-s)*(2*_PI)/p )) + b;
                }
                float postFix =  a*pow(2,-10*(t-=1)); // postIncrement is evil
                return postFix * sin( (t*d-s)*(2*_PI)/p )*.5f + c + b;
        }
        ...
        float Back::easeOut(float t,float b , float c, float d) {
                t=t/d-1;
                return c*((t)*t*((1.70158f + 1)*t + 1.70158f) + 1) + b;
        }

        float Back::easeInOut(float t,float b , float c, float d) {
                float s = 1.70158f;
                s*=(1.525f)+1;
                if ((t/=d/2) < 1) return c/2*(t*t*(s*t - s)) + b;
                float postFix = t-=2;
                s*=(1.525f)+1;
                return c/2*((postFix)*t*((s)*t + s) + 2) + b;
        }
                ...
                void Tweener::step(long currentMillis) {
                    ...
                    if ( t < d  && (*tweensIT).total_properties > 0 ) {
                        ...
                        if ((*tweensIT).timeCount < (*tweensIT).time  ) {
                            for (unsigned int i =0 ; i < (unsigned)(*tweensIT).total_properties; i++ ) {
